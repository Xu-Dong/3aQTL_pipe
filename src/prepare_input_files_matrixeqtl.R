...
pdui_mat.ceu <- readRDS("CEU.pdui_mat.imputed_qnorm.RDS")
pdui_mat.fin <- readRDS("FIN.pdui_mat.imputed_qnorm.RDS")
pdui_mat.gbr <- readRDS("GBR.pdui_mat.imputed_qnorm.RDS")
pdui_mat.tsi <- readRDS("TSI.pdui_mat.imputed_qnorm.RDS")
pdui_mat.yri <- readRDS("YRI.pdui_mat.imputed_qnorm.RDS")
...
write.table(covariates.ceu,file="./matrix-eqtl/input/Covariates.CEU.txt",quote=F,sep="\t",row.names=F,col.names=T)
write.table(covariates.fin,file="./matrix-eqtl/input/Covariates.FIN.txt",quote=F,sep="\t",row.names=F,col.names=T)
write.table(covariates.gbr,file="./matrix-eqtl/input/Covariates.GBR.txt",quote=F,sep="\t",row.names=F,col.names=T)
write.table(covariates.tsi,file="./matrix-eqtl/input/Covariates.TSI.txt",quote=F,sep="\t",row.names=F,col.names=T)
write.table(covariates.yri,file="./matrix-eqtl/input/Covariates.YRI.txt",quote=F,sep="\t",row.names=F,col.names=T)
...
write.table(gt_mat.ceu,file="./matrix-eqtl/input/Genotype_mat.CEU.txt",quote=F,sep="\t",row.names=F,col.names=T)
write.table(gt_mat.fin,file="./matrix-eqtl/input/Genotype_mat.FIN.txt",quote=F,sep="\t",row.names=F,col.names=T)
write.table(gt_mat.gbr,file="./matrix-eqtl/input/Genotype_mat.GBR.txt",quote=F,sep="\t",row.names=F,col.names=T)
write.table(gt_mat.tsi,file="./matrix-eqtl/input/Genotype_mat.TSI.txt",quote=F,sep="\t",row.names=F,col.names=T)
write.table(gt_mat.yri,file="./matrix-eqtl/input/Genotype_mat.YRI.txt",quote=F,sep="\t",row.names=F,col.names=T)
